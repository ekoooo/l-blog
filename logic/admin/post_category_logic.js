...
let PostCategoryLogic = {
    /**
     * 获取文章分类列表
     * @returns {Promise<list>}
     */
    getPostCategory: (formInfo) => new Promise((resolve, reject) => {
     ...
     * @returns {Promise<id>}
     */
    addPostCategory: (formInfo) => new Promise((resolve, reject) => {
        // 验证
...
module.exports = PostCategoryLogic;